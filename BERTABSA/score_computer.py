from transformers import AutoTokenizer, BertForMaskedLM, RobertaTokenizer, RobertaForMaskedLM
from config import *
...
class ScoreComputer:
    ...
    def __init__(self, aspect_vocabularies, sentiment_vocabularies):
        ...
        self.mlm_model = RobertaForMaskedLM.from_pretrained(self.bert_type).to(self.device)
        self.tokenizer = RobertaTokenizer.from_pretrained(self.bert_type)
